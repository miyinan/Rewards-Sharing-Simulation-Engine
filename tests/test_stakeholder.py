...
def test_calculate_margin():
    ...
    pool556.margin = agent157.calculate_margin(pool556)
    pool557.margin = agent157.calculate_margin(pool557)
    pool558.margin = agent159.calculate_margin(pool558)
...
def test_execute_strategy(mocker):
    model = Simulation()
    agent1 = NonMyopicStakeholder(1, model, stake=0.003, cost=0.001)
    agent2 = NonMyopicStakeholder(2, model, stake=0.002, cost=0.001)
    agent3 = NonMyopicStakeholder(3, model, stake=0.001, cost=0.001)
    agent4 = NonMyopicStakeholder(4, model, stake=0.0001, cost=0.001)
